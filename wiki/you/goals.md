...
- Get to a place where parents can retire comfortably
- Build toward supporting a future family
- Open questions: what does "a lot" actually mean? What's the next career move?

## Social & Relationships
- Make a lot of friends
- Find a girlfriend *(current rizz level: 0 — this is a project we can work on)*
- Repair and deepen family bonds — actively recovering from the moody teen era
- Be the kind of person people genuinely want around

## Fitness & Athletics
- Run a marathon
- Do an Ironman eventually *(swim → bike → run, in that brutally long order)*
